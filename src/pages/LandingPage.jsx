...
function LandingPage() {
    return (
        <div className="h-screen grid grid-rows-[2fr_1fr] lg:grid-rows-2 overflow-hidden gap-4 bg-[#F4F9FD] text-gray-700 w-autocontent-center">
            <header className="flex flex-col items-center justify-center text-center md:pt-5 px-5 md:px-10 my-auto z-10 min-h-0 flex-grow">
                ...
                <p className="text-xl md:text-xl mb-6 opacity-80">
            ...
            <div className="h-full flex items-end justify-center px-4 md:px-0 min-h-0 flex-grow">
                <img src="./LandingHero.svg" alt="CRM-HERO" className="h-full max-w-full md:max-w-2xl lg:max-w-6xl max-h-[45vh] md:max-h-[50vh] lg:max-h-[40vh] object-contain" />
            </div>
        </div>
    );
}
