function EmployeeCardLarge() {
  ...
  <div className="w-full grid grid-cols-[repeat(3,1fr)_0.5fr] gap-2 md:grid-cols-[repeat(5,1fr)_0.5fr] bg-[#F4F9FD] hover:bg-[#d3ebff] rounded-[30px] py-2 px-4 items-center text-center">
    ...
    <div><i class="bi bi-three-dots-vertical text-xl"></i></div>
