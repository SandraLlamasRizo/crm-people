...
function DepartmentCardLarge({ departamento, datos }) {
    ...
    return (
        <div className="min-w-[280px] h-[360px] rounded-lg shadow-xl overflow-hidden p-4 flex flex-col bg-white mx-auto">
            <div className="flex-grow flex flex-col justify-between h-full">
                ...
                <div className="flex justify-center items-center gap-4 mb-4">
                    <h5 className="text-sm text-blue-600 font-medium bg-[#E1F0FF] px-3 py-1 rounded-2xl w-[160px] h-[70px] flex items-center justify-center text-center">
                        Salario&nbsp;medio: {datos?.totalEmpleados && datos.totalEmpleados > 0 ? `${(datos.totalSalario / datos.totalEmpleados).toFixed(2)} €` : 'No disponible'}
                    </h5>
