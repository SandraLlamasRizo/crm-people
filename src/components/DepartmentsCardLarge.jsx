...
function DepartmentCardLarge({ departamento, datos }) {
    ...
    return (
        <div className="max-w-[500px] w-full h-[300px] rounded-lg shadow-xl overflow-hidden p-4 flex flex-col justify-between bg-white mx-auto">
            <div>
                <figure>
                    <img
                ...
                <h3 className="text-center text-xl font-semibold text-[#457FBF] mb-1">
                ...
                <div className="flex gap-2">
                    <h5 className="text-sm  text-blue-600  font-medium bg-[#E1F0FF] px-3 py-1 rounded-2xl">
