    ...
    return (
        ...
        <div className="max-w-[500px] w-full h-auto rounded-lg shadow-xl overflow-hidden p-4 flex flex-col gap-4 relative bg-white mx-auto">
            ...
            <div className="flex justify-center items-center gap-4 mb-4">
                ...
                <h5 className="text-sm text-blue-600 font-medium bg-[#E1F0FF] px-3 py-1 rounded-2xl w-[160px] h-[70px] flex items-center justify-center text-center">                        Salario total: {datos?.totalSalario ? `${datos.totalSalario} €` : 'No disponible'}
                    </h5>
                </div>
